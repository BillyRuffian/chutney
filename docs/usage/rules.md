...
[SameTagForDifferentCase](https://github.com/BillyRuffian/chutney/blob/master/features/same_tag_different_case.feature): You have the same tag for all you scenarios; move the tag to the feature level instead. *Since 3.1.0*
